            ...
            {session?.user && (
                <div className="pt-6 border-t border-slate-800 mt-auto">
                    ...
                    {session?.user?.role === 'student' && (
                        <Link href="/student" className="w-full flex items-center gap-3 px-4 py-3 rounded-xl text-blue-400 font-bold text-sm hover:bg-blue-500/10 transition-colors text-left mb-2">
