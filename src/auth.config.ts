    ...
    callbacks: {
        ...
        authorized({ auth, request: { nextUrl } }) {
            ...
            if (isAdminPage) {
                ...
                if (userRole === 'bursar' && (nextUrl.pathname === "/admin/dashboard" || nextUrl.pathname.startsWith("/admin/bursary") || nextUrl.pathname.startsWith("/admin/accounting") || nextUrl.pathname.startsWith("/admin/analytics") || nextUrl.pathname.startsWith("/admin/inventory"))) return true;
