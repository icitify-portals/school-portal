        ...
        <div className="min-h-screen bg-slate-950 flex flex-col md:flex-row">
            ...
            <aside className="w-full md:w-64 bg-slate-900 border-b md:border-b-0 md:border-r border-slate-800 p-6 flex flex-col">
                ...
                <nav className="flex-1 space-y-2">
                    ...
                    <Link href="/applicant/receipts" className="flex items-center gap-3 px-4 py-3 rounded-xl text-slate-400 font-bold text-sm hover:bg-slate-800 hover:text-white transition-colors">
                        <Receipt className="w-4 h-4" />
                        Receipts
                    </Link>
                    <Link href="/guide/applicants" className="flex items-center gap-3 px-4 py-3 rounded-xl text-slate-400 font-bold text-sm hover:bg-slate-800 hover:text-white transition-colors">
