        ...
        <div className="min-h-screen bg-slate-50 md:py-12 print:bg-white print:py-0">
            ...
            <div className="max-w-2xl mx-auto mb-8 px-4 flex justify-between items-center print:hidden">
                ...
                <div className="flex gap-3">
                    <Button variant="outline" onClick={handlePrint} className="gap-2 rounded-xl border-slate-200">
                        <Printer className="w-4 h-4" />
                        Print Receipt
                    </Button>
                    <Button className="gap-2 rounded-xl bg-indigo-600 shadow-lg shadow-indigo-200" onClick={handlePrint}>
