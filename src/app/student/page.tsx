        ...
        <div className="p-4 sm:p-6 lg:p-8 min-h-screen bg-transparent">
            ...
            <div className="space-y-4">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-7 gap-4 auto-rows-[120px]">
                    {[
                        ...((studentRecord?.status === 'nd_graduant' || studentRecord?.status === 'graduated') ? [{ name: "Apply for HND", href: "/applicant", icon: GraduationCap, span: "col-span-2 row-span-1", color: "text-white bg-indigo-600 hover:bg-indigo-700" }] : []),
