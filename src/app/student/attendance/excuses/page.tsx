...
export default function StudentExcusesPage() {
    ...
    return (
        <div className="p-6 md:p-10 max-w-4xl mx-auto space-y-8">
            ...
            {/* Submit Form */}
            {showForm && (
                <Card className="border-none shadow-xl rounded-[2rem] bg-gradient-to-br from-purple-50 to-indigo-50 overflow-hidden animate-in slide-in-from-top-4 duration-300">
