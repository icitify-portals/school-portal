...
export const metadata = {
    title: "Departments | Staff Portal",
    description: "List of all departments and their courses for Staff"
};
        ...
        <div className="container mx-auto py-8">
            <div className="flex flex-col mb-8">
                ...
                <p className="text-muted-foreground mt-2">
                    Browse all academic departments to view their course curriculum.
                </p>
            </div>

            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {departments.map((dept) => (
                    <Link key={dept.id} href={`/staff/departments/${dept.id}`}>
