        ...
        <div className="p-8 space-y-8 bg-slate-50 min-h-screen">
            <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-6">
                <div>
                    ...
                    <p className="text-slate-500 font-medium tracking-tight">Human Resources management dashboard for official identity cards.</p>
                </div>
                <div className="flex gap-4">
                    <Card className="bg-white border-none shadow-sm px-6 py-4 flex items-center gap-4 rounded-2xl">
                        ...
                        <div>
                            ...
                            <p className="text-xl font-black text-slate-900">{cards.filter(c => c.status === 'active').length}</p>
                        </div>
                    </Card>
                </div>
            </div>
            ...
            <Card className="border-none shadow-sm rounded-[32px] overflow-hidden bg-white">
                <CardHeader className="p-8 border-b border-slate-50 flex flex-row items-center justify-between space-y-0">
                    <div>
                        <CardTitle className="text-xl font-black uppercase italic tracking-tight">Institutional Credentials</CardTitle>
                        <CardDescription className="text-slate-400 font-medium tracking-tight">Official staff and student identification records managed by HR.</CardDescription>
                    </div>
                </CardHeader>
