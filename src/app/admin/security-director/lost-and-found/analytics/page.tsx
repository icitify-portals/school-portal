...
export default async function LostFoundAnalyticsPage() {
    ...
    return (
        <div className="p-8 max-w-[1400px] mx-auto space-y-8">
            <Link href="/admin/security-director/lost-and-found" className="text-sm font-bold text-slate-500 hover:text-slate-800 flex items-center gap-2 mb-4 w-fit transition-colors">
                <ArrowLeft className="w-4 h-4" /> Back to Lost & Found
            </Link>

            <div className="flex flex-col space-y-2">
                <h1 className="text-3xl font-black text-slate-900 tracking-tight uppercase">Lost & Found Analytics</h1>
                <p className="text-slate-500 font-bold uppercase tracking-widest text-xs">
                    Insights into campus lost items, recovery rates, and categories.
                </p>
            </div>
