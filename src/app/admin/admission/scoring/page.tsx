  ...
  return (
    <div className="p-4 sm:p-6 lg:p-8 min-h-screen">
        ...
        <div className="relative overflow-hidden bg-slate-900 rounded-3xl p-8 lg:p-12 text-white shadow-2xl border border-slate-800">
            ...
            <div className="relative z-10 flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
                ...
                <div className="flex bg-white/10 p-1.5 rounded-2xl backdrop-blur-md border border-white/10 shadow-inner gap-2 flex-wrap">
                    <button onClick={fetchProgrammes} disabled={loading} className="flex items-center gap-2 px-6 py-4 text-xs font-black uppercase tracking-widest rounded-xl transition-all whitespace-nowrap bg-indigo-600 text-white hover:bg-indigo-500 shadow-lg hover:-translate-y-1">
      ...
      <Card className="border border-white/40 shadow-xl shadow-slate-200/50 bg-white/60 backdrop-blur-3xl rounded-[3rem] p-8">
        <h3 className="text-sm font-black text-slate-700 uppercase tracking-widest mb-4">Select Programme</h3>
