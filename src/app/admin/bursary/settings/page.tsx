                            ...
                            <table className="w-full text-left text-xs border-collapse">
                                ...
                                <tbody className="divide-y divide-slate-100 font-medium">
                                    ...
                                    <tr className="hover:bg-slate-50/50 bg-indigo-50/20">
                                        ...
                                        <td className="p-3 font-bold text-slate-800">FSS TECH STUDIO</td>
                                        <td className="p-3"><span className="px-2.5 py-1 rounded-md text-[11px] font-bold bg-indigo-100 text-indigo-800 border border-indigo-200">FSS TECH STUDIO</span></td>
                                        <td className="p-3 text-right"><span className="text-emerald-600 font-bold">Active</span></td>
                                    </tr>
                                    <tr className="hover:bg-slate-50/50 bg-indigo-50/20">
