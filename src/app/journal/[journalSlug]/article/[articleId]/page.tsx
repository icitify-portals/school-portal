        ...
        <div className="max-w-4xl mx-auto py-12 px-4 space-y-12">
            ...
            <Tabs defaultValue="abstract" className="w-full">
                ...
                <TabsContent value="abstract" className="space-y-6">
                    <Card className="p-8 border-none shadow-xl rounded-[2rem] bg-white group overflow-hidden hover:shadow-2xl transition-all duration-300">
                        <CardHeader className="p-0 mb-4 bg-slate-50/50 border-b border-slate-100 p-6">
