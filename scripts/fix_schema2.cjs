...
// Remove ALL occurrences of the tables using regex
...
// Prepend them after the imports
const insertIndex = content.indexOf('// --- CORE / USER MODULE ---');
const part1 = content.slice(0, insertIndex);
const part2 = content.slice(insertIndex);

const newContent = part1 + newGeneralLedger + '\n\n' + newStudentBills + '\n\n' + newTransactions + '\n\n' + part2;
